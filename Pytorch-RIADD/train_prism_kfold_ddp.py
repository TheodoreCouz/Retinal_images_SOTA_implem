...
from timm.data import PrismDataSet as RiaddDataSet  # PRISM: filename incl. extension
...
parser.add_argument('--data',default='/home/cousin/research/Fiber_dino/PRISM v1/train',type=str,
...
parser.add_argument('--output', default='ckpt/tf_efficientnet_b6_ns-PRISM-KFOLD-SGD1E-1', type=str, metavar='PATH',
...
if __name__ == '__main__':
    ...
    data_ = pd.read_csv('/home/cousin/research/Fiber_dino/PRISM v1/train_labels.csv')
