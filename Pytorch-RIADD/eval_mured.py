...
from timm.data import get_riadd_valid_transforms, PrismDataSet as MuredDataSet

MURED_DIR = "/storage2/cousin/datasets/MURED"
MURED_IMG_DIR = f"{MURED_DIR}/images/images"
...
def evaluate(ckpt_path, split_name, img_dir, label_csv, num_classes=20):
    ...
    ds = MuredDataSet(image_ids=df, baseImgPath=img_dir)
...
if __name__ == '__main__':
    ...
    if ckpt_path is None:
        print("Usage: python eval_mured.py <path/to/model_best.pth.tar>")
        sys.exit(1)

    val_res = evaluate(ckpt_path, 'MURED Validation', MURED_IMG_DIR, f'{MURED_DIR}/val_labels.csv')
    test_res = evaluate(ckpt_path, 'MURED Test', MURED_IMG_DIR, f'{MURED_DIR}/test_labels.csv')
