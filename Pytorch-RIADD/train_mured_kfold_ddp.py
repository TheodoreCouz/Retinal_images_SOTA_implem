...
parser.add_argument('--data',default='/storage2/cousin/datasets/MURED/images/images',type=str,
...
parser.add_argument('--output', default='ckpt/tf_efficientnet_b6_ns-MURED-KFOLD-SGD1E-1', type=str, metavar='PATH',
...
if __name__ == '__main__':
    ...
    data_ = pd.read_csv(os.environ.get(
        'MURED_TRAIN_CSV',
        '/storage2/cousin/datasets/MURED/train_labels_stratified.csv'))
