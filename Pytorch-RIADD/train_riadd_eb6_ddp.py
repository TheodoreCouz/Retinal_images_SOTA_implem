...
parser.add_argument('--data',default='/storage2/cousin/datasets/RFMiD/Training',type=str,
...
parser.add_argument('--num-classes', type=int, default=29, metavar='N',
...
parser.add_argument('--output', default='ckpt/tf_efficientnet_b6_ns-RIADD-DDP-RemoveBlack-768-V4-SGD1E-1', type=str, metavar='PATH',
